...
public class Parameter {
	...
	public static String RATING_TYPE = "binary"; //"binary", "multinominal", "real"
	
	//Agent Configuration//
	public static int TOTAL_NO_OF_BUYERS =100;
	public static int TOTAL_NO_OF_SELLERS =30;
	public static int NO_OF_HONEST_BUYERS = 70;
	public static int NO_OF_DISHONEST_BUYERS = 30;
	public static int NO_OF_HONEST_SELLERS = 18;
	public static int NO_OF_DISHONEST_SELLERS = 12;
	...
	//Product Catalogue
	public static HashMap productNo = new HashMap();
	
	public static void createPdtCatalog(){
		DecimalFormat roundoff = new DecimalFormat("#.##");
		for (int a =0; a<product; a++){
			productNo.put(a, Double.valueOf(roundoff.format(PseudoRandom.randDouble(Parameter.min_price, Parameter.max_price))));
		}
	}
...
//		"alwaysUnfair", "camouflage", "whitewashing",  "sybil",  "sybil_camouflage", "sybil_whitewashing", 
		...
		{
			if(((String) atkNameList.get(i)).equalsIgnoreCase("whitewashing") || ((String) atkNameList.get(i)).equalsIgnoreCase("sybil_whitewashing")){			
...
//		"alwaysUnfair", "camouflage", "whitewashing",  "sybil",  "sybil_camouflage", "sybil_whitewashing", 
		...
		if(attackName.equalsIgnoreCase("sybil")
				|| attackName.equalsIgnoreCase("sybil_whitewashing") || attackName.equalsIgnoreCase("sybil_camouflage") || attackName.equalsIgnoreCase("sybil_betray")){			
			include = true;
		}
